...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:40,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Pierwsza",sLast:"Ostatnia",sNext:"Nastepna",sPrevious:"Poprzednia"},sEmptyTable:"Brak danych w tabeli",sInfo:"Wyświetla _START_ do _END_ z _TOTAL_ wyników",sInfoEmpty:"Wyświetla 0 do 0 z 0 wyników",sInfoFiltered:"(odfiltrowane z _MAX_ wszystkich wyników)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"Ładowanie...",sProcessing:"W trakcie...",sSearch:"Szukaj:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Nie znaleziono pasujących wyników"},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};E(u.defaults);u.defaults.column={aDataSort:null,
